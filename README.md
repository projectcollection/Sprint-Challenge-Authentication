...
1. What is the purpose of using _sessions_?
    ...
    Its a way for servers to remember authenticated clients so that it can authorize them to access resources. 

1. What does bcrypt do to help us store passwords in a secure manner.

    It hashes them a specified number of times so that the stored passwords are encrypted and safe.

1. What does bcrypt do to slow down attackers?

    It encrypts a password a number of iterations which multiplies the time it takes for attackers to find the password using rainbow tables by the number of iterations.
